...
import { createTableSchema, createRoomSchema } from '../validators/index.js';
...
router.patch('/tables/:id', protect, restrictTo('manager', 'admin'), updateTable);
...
router.patch('/rooms/:id', protect, restrictTo('manager', 'admin'), updateRoom);
